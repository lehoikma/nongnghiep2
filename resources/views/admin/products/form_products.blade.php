        ...
        <form action="{{route('save_products')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <input type="text" name="title_products" class="form-control" placeholder="Nhập tên sản phẩm ..." value="{{old('title_news')}}">
                </div>
            ...
            <div class=" col-md-8" style="margin-top: 10px">
                <input name="status" type="checkbox" value="1"> Tích chọn bài viết hiện thị ngoài slide
            </div>
