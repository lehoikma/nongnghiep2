...
class IntroducesController extends Controller
{
    ...
    public function formIntroduce1()
    {
        ...
        return view('admin.introduces.form_introduce_1', [
            'data' => $data
        ]);
    }
    ...
    public function formIntroduce2()
    {
        ...
        return view('admin.introduces.form_introduce_2', [
            'data' => $data
        ]);
    }
    ...
    public function formIntroduce3()
    {
        ...
        return view('admin.introduces.form_introduce_3', [
            'data' => $data
        ]);
    }

    public function formIntroduce4()
    {
        $data = Introduces::find(4);
        return view('admin.introduces.form_introduce_4', [
            'data' => $data
        ]);
    }
